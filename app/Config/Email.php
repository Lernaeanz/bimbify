...
class Email extends BaseConfig
{
    ...
    public string $fromEmail = 'tahtaanugrah@gmail.com'; // Ganti dengan alamat email Anda
    public string $fromName  = 'Admin Pengaduan';
     ...
     * SMTP Username
     */
    public string $SMTPUser = 'tahtaanugrah@gmail.com'; // Ganti dengan email SMTP Anda

    /**
     * SMTP Password
     */
    public string $SMTPPass = 'fiej dtyr vonz rvjd'; // Ganti dengan password email SMTP Anda

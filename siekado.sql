...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2024 at 05:27 AM
...
(24, 'Akas Sakti', 1276371, 'ajsdhjh', 'S4B', 'Matematika', '1717483579_4db0fee15bda4007b56b.jpg');
...
(28, 17, 'asdjhkasjhdu', 'asjdnajksdhuiasd'),
(29, 22, 'akjshdkjahd', 'kasdukashd'),
(30, 22, 'aslihalskdj', 'jaksdjahsdjl'),
(31, 18, 'coba lagi', 'maaf anda belum beruntung');
...
(4, 'Dosen selalu membawakan materi dengan penuh tanggung jawab'),
...
INSERT INTO `user` (`id`, `name`, `email`, `password`, `level`, `kelas`, `gambar`) VALUES
(1, 'admin', 'admin@gmail.com', 'admin', 'admin', '', NULL),
(14, 'dodi', 'dods@gmail.com', 'dodi', 'user', 'S4B', NULL),
(19, 'Kom-sejeong', 'ksj@gmail.com', 'ksj', 'user', 'S4A', '1717331292_95838549065b9e9e0bb6.jpeg'),
(20, 'park bo-young', 'pby@gmail.com', 'pby', 'user', 'S4B', '1717331330_91c8572aefa9e8dbd7f8.jpeg'),
(21, 'Im Yoon-ah', 'iya@gmail.com', 'iya', 'user', 'S4B', '1717450614_2c4ff37fa30129358af1.jpeg'),
(22, 'Go Youn-Jung', 'gyj@gmail.com', 'gyj', 'user', 'S4A', '1717450693_56a480fdc3a187965008.jpeg');
...
--
ALTER TABLE `average_ipd`
  MODIFY `id_avg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `feedback`
  MODIFY `id_fb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `jawaban`
--
ALTER TABLE `jawaban`
  MODIFY `id_jawaban` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=656;
